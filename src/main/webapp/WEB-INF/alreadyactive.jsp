...
<html>
    <head>
        ...
        <title>User Agreement Already Completed</title>
    </head>
    <body>
        <div class="container-fluid">
            <h1>User Agreement Already Completed</h1>
            <div id="thankyou" class="alert alert-info" role="alert">You already completed the user agreement.</div>
        </div>
    </body>
</html>
